...
from .bbox import get_corners, rotate_im, rotate_box, get_enclosing_box
    ...
    def __call__(self, image, boxes=None, labels=None):
        ...
        while True:
            ...
            for i in range(600):
                ...
                if overlap.max() < iou_thre * (600 - i) / 600:
                    continue
